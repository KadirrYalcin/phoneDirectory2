...
class _RestClient implements RestClient {
  ...
  @override
  Future<UserResponseModel> loginService(UserLoginModel userLoginModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(userLoginModel.toJson());
    final _options = _setStreamType<UserResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<List<PersonResponseModel>> getAllUsers(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PersonResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<PersonResponseModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              PersonResponseModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<PersonResponseModel> getPersonById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PersonResponseModel _value;
    try {
      _value = PersonResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<PersonResponseModel> createPerson(
    ...
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    final _data = await createPersonRequestModel.toFormData();
    final _options = _setStreamType<PersonResponseModel>(Options(
  ...
  Future<PersonResponseModel> updatePerson(
    ...
    final _options = _setStreamType<PersonResponseModel>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'person/Person/UpdatePerson/${personId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<PersonResponseModel> deletePerson(
    ...
    final _options = _setStreamType<PersonResponseModel>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'person/Person/DeletePerson/${personId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
